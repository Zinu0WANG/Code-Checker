...
class FeishuNotifier:
    ...
    def send_message(self, content, msg_type='text', title=None, is_at_all=False, project_group=None, project_name=None, url_slug=None):
        """
        发送飞书消息
        :param content: 消息内容
        ...
        try:
            post_url = self._get_webhook_url(project_group=project_group ,project_name=project_name, url_slug=url_slug)
